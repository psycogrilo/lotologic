        ...
        {mode === "manual" && !isDone && (
          <div className="rounded-xl border border-slate-800 bg-[#111827] p-5 space-y-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {analysis && (
                <div className={`rounded-lg px-3 py-1.5 text-xs font-bold ${analysis.dominantGroup && GROUP_CFG[analysis.dominantGroup] ? GROUP_CFG[analysis.dominantGroup].bg + " " + GROUP_CFG[analysis.dominantGroup].text + " border " + GROUP_CFG[analysis.dominantGroup].border : "bg-slate-700 text-slate-300 border-slate-600"}`}>
